import { auth, provider, signInWithPopup, signOut, onAuthStateChanged, signInWithEmailAndPassword, createUserWithEmailAndPassword } from './firebase-config.js?v=36';
import { DataStore } from './datastore.js?v=36';
import { showModal } from './ui_v23.js?v=36';
