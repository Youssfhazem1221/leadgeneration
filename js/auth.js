import { auth, provider, signInWithPopup, signOut, onAuthStateChanged, signInWithEmailAndPassword, createUserWithEmailAndPassword } from './firebase-config.js?v=37';
import { DataStore } from './datastore.js?v=37';
import { showModal } from './ui_v23.js?v=37';
