...
export { app, auth, db, provider, signInWithPopup, signOut, onAuthStateChanged, collection, addDoc, getDocs, updateDoc, doc, deleteDoc, onSnapshot, setDoc, query, orderBy, getDoc };
